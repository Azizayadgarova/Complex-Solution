...
const CardItem = ({ number, title, description }) => {
  return (
    <motion.div
      ...
      className='relative bg-[#F7F7F7] rounded-2xl shadow-xl p-6 w-full h-full flex flex-col justify-between items-start text-left overflow-hidden hover:shadow-2xl transition duration-300'
    >
  ...
  return (
    <section className="bg-white px-4 md:px-8 lg:px-20 py-16">
      <div className='flex flex-col items-center text-center mb-12'>
        <h4 className='text-[28px] sm:text-[32px] md:text-[36px] text-[#0E1F51] font-bold max-w-3xl leading-snug'>
          {t('Texnik yordam va qo‘llab-quvvatlash') || "Texnik yordam va qo‘llab-quvvatlash:"}
        </h4>
      </div>
