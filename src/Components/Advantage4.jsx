...
const CardItem = ({ number, title, description }) => {
  return (
    ...
    >
      ...
      <h3 className="text-[#0E1F51] font-bold text-lg md:text-[22px] mb-2 relative z-10">
        {title}
        <span className="block h-0.5 w-12 bg-[#FF3E54] mt-2"></span>
      </h3>
      <p className="text-[#0E1F51] text-sm md:text-[16px] leading-relaxed mt-auto relative z-10">
        {description}
      </p>
    </motion.div>
  );
...
const Advantage4 = () => {
  ...
  const items = [
    {
      number: '01',
      title: t('Dasturiy taminotni doimiy yangilab borish') || "Doimiy texnik yangilanishlar",
      description:
    ...
    {
      number: '02',
      title: t('Tizimni modernizatsiya qilish:') || "Tizimni modernizatsiya qilish",
      description:
    ...
    {
      number: '04',
      title: t('Monitoring va tahlil:') || "Xatolik va muammolarga yechim",
      description:
    ...
    {
      number: '05',
      title: t('Foydalanuvchilarni o‘qitish va konsultatsiya:') || "Xatolik va muammolarga yechim",
      description:
  ...
  return (
    <section className="bg-white py-8 px-4 md:px-8 lg:px-20">
      <div className="flex flex-col items-center mb-12">
        <h4 className="text-2xl md:text-3xl lg:text-[35px] w-full md:w-2/3 lg:w-1/2 text-center text-[#0E1F51] font-bold">
          Texnik yordam va dasturiy ta’minotni qo‘llab-quvvatlash
        </h4>
      </div>
